# Program to generate the sounds of notes of a prometheus scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a prometheus scale
    notes_interval = [2, 2, 2, 3, 1, 2, 2] 
    ...
    # Return list of frequencies in the ascending and descending notes of the prometheus scale    
...
# Scale list for which the prometheus scale will be played in sequence
scale_list = ['C4']
